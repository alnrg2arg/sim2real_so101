...
**30fps 추론 성공 영상 (front view)**

| ep00 (yaw 161°) | ep01 (yaw 66°) | ep02 (yaw 32°) | ep03 (yaw 82°) | ep04 (yaw -12°) |
|:--:|:--:|:--:|:--:|:--:|
| ![ep00](inference_results/v41_30fps/SUCCESS_ep00_x0y-0yaw161_ret86/front.gif) | ![ep01](inference_results/v41_30fps/SUCCESS_ep01_x0y-1yaw66_ret67/front.gif) | ![ep02](inference_results/v41_30fps/SUCCESS_ep02_x0y-0yaw32_ret62/front.gif) | ![ep03](inference_results/v41_30fps/SUCCESS_ep03_x0y-0yaw82_ret61/front.gif) | ![ep04](inference_results/v41_30fps/SUCCESS_ep04_x0y-0yaw-12_ret61/front.gif) |

원본 30fps mp4 (front / side / wrist) + `trajectory.npz` 는 [`inference_results/v41_30fps/`](inference_results/v41_30fps/) 에. 자세한 표·다운로드는 [§5.6 — 실제 추론 결과](#56-실제-추론-결과-v41_30fps) 참고.
...
[`inference_results/v41_30fps/`](inference_results/v41_30fps/) 에 v41 best checkpoint의 30fps 추론 결과 5개 SUCCESS 에피소드를 포함했습니다. 각 에피소드 디렉토리에는 `front.mp4`, `side.mp4`, `wrist.mp4` (30fps H.264, 480×640 / wrist 128×128) 와 `trajectory.npz` (qpos / actions / target_qpos / cube_pose 시계열) 가 들어있습니다. README 미리보기용으로 `front.gif` (480×360, 12fps, ~2 MB) 도 함께 포함. 카메라 raw `cam_*.npz` (에피소드당 ~150 MB) 는 repo 용량을 위해 제외 — 동일 ckpt + `infer_sac.py` 로 재생성 가능합니다.

| 에피소드 | spawn yaw | reward | front (preview) |
|---------|----------|--------|-----------------|
| `ep00`  | 161°  | 86 | ![ep00](inference_results/v41_30fps/SUCCESS_ep00_x0y-0yaw161_ret86/front.gif) |
| `ep01`  | 66°   | 67 | ![ep01](inference_results/v41_30fps/SUCCESS_ep01_x0y-1yaw66_ret67/front.gif) |
| `ep02`  | 32°   | 62 | ![ep02](inference_results/v41_30fps/SUCCESS_ep02_x0y-0yaw32_ret62/front.gif) |
| `ep03`  | 82°   | 61 | ![ep03](inference_results/v41_30fps/SUCCESS_ep03_x0y-0yaw82_ret61/front.gif) |
| `ep04`  | -12°  | 61 | ![ep04](inference_results/v41_30fps/SUCCESS_ep04_x0y-0yaw-12_ret61/front.gif) |

> 5/5 SUCCESS (hold-ratio ≥ 80% 모두 만족). 영상 11초 / decimation=3 (~33 Hz physics) / 30 fps H.264 인코딩.
> 각 에피소드 디렉토리에 원본 mp4 (front / side / wrist) + trajectory.npz 가 같이 들어있어 LeRobot 변환에 그대로 사용할 수 있습니다.
